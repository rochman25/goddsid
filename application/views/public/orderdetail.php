    ...
    <div class="orderpage">
        <section class="left-column">
            <div class="ticker">
                ...
                <span>Hubungi Whatsapp 083835525656 jika terjadi kendala dalam proses belanja</span>
            </div>
            <div class="content" style="overflow: hidden;">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="title">
                            <p style="color: #5a5a5a;"> <?= $profil->alamat_1 . " " . $profil->alamat_2 ?> </p>
                        </div>
                        <div class="title">
                            <p style="color: #5a5a5a;"> <?= $profil->kecamatan ?> </p>
                        </div>
                        <div class="title">
                            <p style="color: #5a5a5a;"> <?= $profil->kabupaten . " " . $profil->kode_pos ?> </p>
                        </div>
                        <div class="title">
                            <p style="color: #5a5a5a;"> <?= $profil->provinsi ?> </p>
                        </div>
                        <div class="title">
                            <p style="color: #5a5a5a;"> <?= "Indonesia" ?> </p>
                        </div>
